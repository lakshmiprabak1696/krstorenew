...
class ControllerExtensionPaymentRazorpay extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->post['payment_razorpay_account'])) {
            $data['payment_razorpay_account'] = $this->request->post['payment_razorpay_key_secret'];
        } else {
            $data['payment_razorpay_account'] = $this->config->get('payment_razorpay_account');
        }
